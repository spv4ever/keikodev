...
def privacidad_details()->rx.Component:
    return rx.chakra.vstack(
        ...
        rx.chakra.text("""El presente Política de Privacidad establece los términos en que keikodev.es usa y protege la
                    ...
                    hacemos asegurando que sólo se empleará de acuerdo con los términos de este documento.
                    ...
                    keikodev.es está altamente comprometido para cumplir con el compromiso de mantener su
                    ...
                    servicio de los sitios web, estás no dan acceso a información de su ordenador ni de usted, a
                    menos de que usted así lo quiera y la proporcione directamente noticias. Usted puede aceptar
                    o negar el uso de cookies, sin embargo la mayoría de navegadores aceptan cookies
                    ...
                    que usted de clic en estos enlaces y abandone nuestra página, ya no tenemos control sobre alsitio al que es redirigido y por lo tanto no somos responsables de los términos o privacidad ni
                    ...
                    keikodev.es Se reserva el derecho de cambiar los términos de la presente Política de
